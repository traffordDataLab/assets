/*
    ...
    Purpose:        Provided as an accompaniment to the Isochrones plugin for Leaflet - provides a simple method to fetch data from an API using a GET request via AJAX and pass the parsed JSON data back via a callback function.
    Dependencies:   None
